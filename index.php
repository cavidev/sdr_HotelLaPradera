...
<html>
    ...
    <body ng-app="HotelLaPradera"> <!-- -->
        ...
        <script type="text/javascript" src="appWEB/reservar/servicio/reservar.js"></script>
        ...
        <script type="text/javascript" src="appWEB/reservar/controlador/reservar.js"></script>
    </body>
</html>